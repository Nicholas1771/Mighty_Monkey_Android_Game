...
public final class aej extends adj<aej> implements Cloneable {
    ...
    private byte[] zzctV = C0499ads.zzcsI;
    private aeh zzctW = null;
    public byte[] zzctX = C0499ads.zzcsI;
    ...
    public byte[] zzcue = C0499ads.zzcsI;
    private String zzcuf = "";
    private int zzcug = 0;
    private int[] zzcuh = C0499ads.zzcsC;
    ...
    public final void zza(adh adh) throws IOException {
        ...
        if (!Arrays.equals(this.zzctV, C0499ads.zzcsI)) {
            adh.zzb(4, this.zzctV);
        }
        if (!Arrays.equals(this.zzctX, C0499ads.zzcsI)) {
        ...
        if (!Arrays.equals(this.zzcue, C0499ads.zzcsI)) {
