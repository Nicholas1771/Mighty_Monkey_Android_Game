...
public final class zzcoo extends zza {
    ...
    public final boolean equals(Object obj) {
        ...
        return zzbe.equal(Long.valueOf(this.f1220id), Long.valueOf(zzcoo.f1220id)) && zzbe.equal(Integer.valueOf(this.type), Integer.valueOf(zzcoo.type)) && zzbe.equal(this.zzbws, zzcoo.zzbws) && zzbe.equal(this.zzbxD, zzcoo.zzbxD) && zzbe.equal(this.zzbxE, zzcoo.zzbxE) && zzbe.equal(Long.valueOf(this.zzbxF), Long.valueOf(zzcoo.zzbxF)) && zzbe.equal(this.zzbxG, zzcoo.zzbxG);
    }
    ...
    public final int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f1220id), Integer.valueOf(this.type), this.zzbws, this.zzbxD, this.zzbxE, Long.valueOf(this.zzbxF), this.zzbxG});
    }

    public final void writeToParcel(Parcel parcel, int i) {
        int zze = zzd.zze(parcel);
        zzd.zza(parcel, 1, this.f1220id);
