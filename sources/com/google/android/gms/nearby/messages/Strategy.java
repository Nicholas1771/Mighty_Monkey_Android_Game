...
public class Strategy extends zza {
    ...
    public static class Builder {
        ...
        public Builder setTtlSeconds(int i) {
            zzbo.zzb(i == Integer.MAX_VALUE || (i > 0 && i <= 86400), "mTtlSeconds(%d) must either be TTL_SECONDS_INFINITE, or it must be between 1 and TTL_SECONDS_MAX(%d) inclusive", Integer.valueOf(i), Integer.valueOf(Strategy.TTL_SECONDS_MAX));
            this.zzbyu = i;
            return this;
        }
    ...
    static {
        Strategy build = new Builder().zzbr(2).setTtlSeconds(TTL_SECONDS_INFINITE).build();
        BLE_ONLY = build;
        zzbyl = build;
    }
    ...
    Strategy(int i, int i2, int i3, int i4, boolean z, int i5, int i6, int i7) {
        ...
        if (!z) {
            ...
            this.zzbyq = 2;
            this.zzbyn = TTL_SECONDS_INFINITE;
        }
        this.zzbys = i7;
    }
