...
public class TokenPendingResult extends PendingResult<TokenResult> {
    ...
    public TokenResult await() {
        try {
            ...
            setResult((String) null, (String) null, (String) null, 14);
        }
        return getResult();
    }
    ...
    public TokenResult await(long l, @NonNull TimeUnit timeUnit) {
        try {
            if (!this.latch.await(l, timeUnit)) {
                setResult((String) null, (String) null, (String) null, 15);
            }
        } catch (InterruptedException e) {
            setResult((String) null, (String) null, (String) null, 14);
        }
    ...
    public void cancel() {
        setResult((String) null, (String) null, (String) null, 16);
    ...
    public void setResultCallback(@NonNull ResultCallback<? super TokenResult> resultCallback2, long l, @NonNull TimeUnit timeUnit) {
        try {
            if (!this.latch.await(l, timeUnit)) {
                setResult((String) null, (String) null, (String) null, 15);
            }
